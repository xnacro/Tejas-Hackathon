    ...
    <div className="p-4 rounded-3xl glass-panel border border-white shadow-md space-y-3">
      ...
      <div className="grid grid-cols-3 gap-2">
        <div className="p-2.5 rounded-2xl bg-white border border-slate-200/80 text-center shadow-2xs">
          <div className="text-lg font-black text-slate-800 leading-tight">{totalObjects}</div>
          <div className="text-[9px] font-semibold text-slate-400 mt-0.5">Objects Detected</div>
        </div>

        <div className="p-2.5 rounded-2xl bg-white border border-slate-200/80 text-center shadow-2xs">
          <div className="text-lg font-black text-blue-600 leading-tight">{trackedCount}</div>
          <div className="text-[9px] font-semibold text-slate-400 mt-0.5">Tracked Objects</div>
        </div>

        <div className="p-2.5 rounded-2xl bg-white border border-slate-200/80 text-center shadow-2xs">
          <div className={`text-lg font-black leading-tight ${highRiskCount > 0 ? "text-rose-600" : "text-emerald-600"}`}>
            {highRiskCount}
          </div>
      ...
      <div className="grid grid-cols-2 gap-2">
        <div className="p-2.5 rounded-2xl bg-slate-50 border border-slate-200 text-left">
          ...
          <div className={`text-sm font-extrabold mt-0.5 ${predictedConflicts > 0 ? "text-rose-600" : "text-slate-700"}`}>
        ...
        <div className="p-2.5 rounded-2xl bg-slate-50 border border-slate-200 text-left">
          ...
          <div className={`text-sm font-extrabold mt-0.5 ${pathRiskPct > 50 ? "text-rose-600" : "text-emerald-600"}`}>
            {pathRiskPct}% Risk
          </div>
        </div>
      </div>
